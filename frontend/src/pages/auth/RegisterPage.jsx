...
const roleOptions = [
  { value: 'teacher', label: 'Guru', emoji: '👨‍🏫' },
  { value: 'student', label: 'Siswa', emoji: '🎓' },
  { value: 'company', label: 'Perusahaan', emoji: '🏢' },
];
...
export default function RegisterPage() {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name === 'password') {
      setFieldErrors((prev) => ({ ...prev, password: '', password_confirmation: '' }));
    } else {
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200/60 bg-white/80 p-8 shadow-xl shadow-slate-200/50 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Role */}
            <div>
              <label className="mb-2 block text-xs font-medium text-slate-600">Saya adalah</label>
                ...
                {roleOptions.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1.5 rounded-xl border px-2 py-4 transition-all duration-200 ${
                        selected
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                  <svg className="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /></svg>
                </div>
                <input
                  type="text"
                  name="name"
                  ...
                  className="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-4 text-sm text-slate-900 placeholder-slate-400 transition-all focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                  required
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={form.password}
                  onChange={handleChange}
                  className="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-11 text-sm text-slate-900 placeholder-slate-400 transition-all focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                  required
                />
                <button
                  type="button"
            ...
            <div>
              ...
              {fieldErrors.password_confirmation && <p className="mt-1.5 text-xs text-red-600">{fieldErrors.password_confirmation}</p>}
            </div>
